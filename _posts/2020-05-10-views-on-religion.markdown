...
Another such quote from [Paul Dirac](https://en.wikipedia.org/wiki/Paul_Dirac) is(my views will overlap to the maximum extent with Dirac. But this was big that's why I didn't keep it on the photo)
{% highlight markdown %}
...
![alt text]( {{"/img/" | prepend: site.baseurl | append : pbdot.jpeg}} "Pale blue dot")
![alt text](/img/pbdot.jpeg "Pale blue dot")
